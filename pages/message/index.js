...
const conversationData = [
  {
    ...
    profileImage: require('./assets/icons8-profile.png'),
  },
  {
    id: '2',
    username: 'user2',
    message: 'Hai, ada rencana apa hari ini?',
    profileImage: require('./assets/icons8-profile.png'),
  },
  {
    id: '3',
    username: 'user3',
    message: 'Halo! Sudah lama tidak berbicara.',
    profileImage: require('./assets/icons8-profile.png'),
  },
  // Tambahkan percakapan lain di sini
];

function MsgScreen({ navigation }) {
