    ...
    Alert.alert('Info', 'Profile updated successfully!', [
      {
        ...
        onPress: () => {
          setProfileUpdated(true);
          // Navigasi ke halaman Home setelah mengklik "OK"
          // Pastikan Anda memiliki mekanisme navigasi yang sesuai, misalnya React Navigation
          navigation.navigate('Home');
        },
      },
    ]);
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.headerTextContainer}>
          <TouchableOpacity>
            <Image
              source={require('./assets/clear.png')} // Ganti dengan path gambar Anda
      ...
      <View style={styles.profileInfo}>
        ...
        <View style={styles.profileImageContainer}>
          <Image
            source={{
              uri: 'https://i2.wp.com/blog.tripcetera.com/id/wp-content/uploads/2020/10/pulau-padar.jpg',
            }}
