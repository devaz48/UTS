      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerIcons}>
          <TouchableOpacity onPress={handleIcon1Click}>
            <Image
              source={require('./assets/icon1.png')} // Replace with your left image
              style={styles.headerImage}
            />
          </TouchableOpacity>
      ...
      <View style={styles.profileContainer}>
        ...
        <View style={styles.imageStatsContainer}>
          <View style={styles.profileImageContainer}>
            <Image
              source={{ uri: 'https://i2.wp.com/blog.tripcetera.com/id/wp-content/uploads/2020/10/pulau-padar.jpg' }}
